...
module.exports = {
  ...
  async bookById(req, res) {
    ...
    const book = await connection("books").select("*").where("id", id).first();
  ...
  async indexByRead(req, res) {
    ...
    if (read == "all") {
      ...
      const [count] = await connection("books").where("read", read).count();
      res.header("X-Total-Count", count["count"]);
  ...
  async updateById(req, res) {
    ...
    await connection("books").where("id", id).update({ read: read });
  ...
  async delete(req, res) {
    ...
    const book = await connection("books").where("id", id).first();
